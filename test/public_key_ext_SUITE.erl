...
-define(SAMPLE_CSR_AS_STRING, "-----BEGIN CERTIFICATE REQUEST-----

...
-export([ happy_path_for_CSR_parsing/1,
          happy_path_for_CSR_parsing_should_work_for_strings_as_well/1,
          verify_that_CN_is_extracted_properly/1 ]).

all() ->
  [ happy_path_for_CSR_parsing,
    happy_path_for_CSR_parsing_should_work_for_strings_as_well,
...
happy_path_for_CSR_parsing_should_work_for_strings_as_well(_Context) ->
  ?assert(is_record(public_key_ext:parse_csr_in_pem_format(?SAMPLE_CSR_AS_STRING), 'CertificationRequest')).
